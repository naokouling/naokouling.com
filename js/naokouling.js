...
(function($){
    ...
    var ADDRESS_URL_PREFIX = 'https://btc.com/'
    ...
    function update_p2sh_address() {
        ...
        $('#mgenAddrQR').html(qrCode.createImgTag(4));
        $('#mgenAddrURL').attr('href', ADDRESS_URL_PREFIX+p2sh_addr);
        $('#mgenAddrURL').attr('title', p2sh_addr);
    }
