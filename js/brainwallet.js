(function($){
    ...
    var ADDRESS_URL_PREFIX = 'http://idgui.com';//'https://btc.com'
	if (window.location.href.indexOf('doge')>=0 ){
		PUBLIC_KEY_VERSION = 0x1E;
		PRIVATE_KEY_VERSION = 0x9E;
	}if (window.location.href.indexOf('ltc')>=0 ){
		PUBLIC_KEY_VERSION = 0x30;
		PRIVATE_KEY_VERSION = 0xB0;
	}if (window.location.href.indexOf('wic')>=0 ){
		PUBLIC_KEY_VERSION = 0x49;
		PRIVATE_KEY_VERSION = 0x99;
	}if (window.location.href.indexOf('ppc')>=0 ){
		PUBLIC_KEY_VERSION = 0x37;
		PRIVATE_KEY_VERSION = 0xB7;
	}if (window.location.href.indexOf('btg')>=0 ){
		PUBLIC_KEY_VERSION = 0x26;
    ...
    {
        if (ADDRESS_URL_PREFIX.indexOf('blockchain.com')>=0 )
          return ADDRESS_URL_PREFIX+'/zh-cn/btc/address/'+addr;
        else if (ADDRESS_URL_PREFIX.indexOf('idgui.com')>=0 )
          return ADDRESS_URL_PREFIX+ "/t/?" + addr;
        else
    ...
    $(document).ready( function() {
		...
		$('#togglePass').on('click', function(){
            var types = $('#secs').attr('type');
            types = (types === 'text' ? 'password' : 'text');
			$('#pass').val('');
            $('#secs').attr('type', types);
        });
